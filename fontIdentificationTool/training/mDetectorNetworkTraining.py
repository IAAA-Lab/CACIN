...
sys.path.append('..')
import training
from training.networks.Layer5FixedConvWithSizeNetwork import Layer5FixedConvWithSizeNetwork
...
mDetectorNetworkTemporalFile ='../../data/tmp/network-training-data/mDetector'+filepattern+'Weights.h5';
mDetectorNetworkFile ='../../data/output/neuronal-network/mDetector'+filepattern+'Network.h5';
mDetectorNetworkQualityReportFile ='../../data/output/neuronal-network/mDetector'+filepattern+'QualityReport.txt';
...
if __name__ == "__main__":
    ...
    netTrainer = Layer5FixedConvWithSizeNetwork(traiCollectionMDetectorOutputFile,mDetectorNetworkTemporalFile, patience, epochs, imgRotationRange);
    print('Entrenando');
